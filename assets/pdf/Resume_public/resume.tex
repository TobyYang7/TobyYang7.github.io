...
\geometry{left=1cm, top=.8cm, right=1cm, bottom=0.5cm, footskip=.5cm}
...
\name{\bf{Yuzhe}}{\bf{Yang}}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}

% \address{YOUR ADDRESS}
\mobile{+86 183-1076-2536}
\email{yuzheyang@link.cuhk.edu.cn}
%\dateofbirth{January 1st, 1970}
\homepage{tobyyang7.github.io} 
\github{github.com/tobyyang7}
